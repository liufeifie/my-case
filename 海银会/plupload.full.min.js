 ...
 * https://blog.csdn.net/lgh1117/article/details/39494633
 *
 * Date: 2014-05-14
 */
! function(e, t) {
		...
		function c() {
			...
			function d(e) {
				...
				return h.setRequestHeader("Content-Type", "multipart/form-data; boundary=" + t), e.each(function(e, a) {
					r += e instanceof o ? n + t + i + 'Content-Disposition: form-data; name="' + a + '"; index="2" filename="' + unescape(encodeURIComponent(e.name || "blob")) + '"' + i + "Content-Type: " + (e.type || "application/octet-stream") + i + i + e.getSource() + i : n + t + i + 'Content-Disposition: form-data; name="' + a + '"' + i + i + unescape(encodeURIComponent(e)) + i
				}), r += n + t + n + i
			}
			var f = this,
				h, p;
	...
	o.addFileFilter("mime_types", function(e, t, n) {
		...
		function k(e, n) {
			...
			function p() {
				...
				}), t.Env.browser === "IE" && t.Env.version <= 9 && m.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded'), v = new t.FormData, o.each(o.extend(g, e.settings.multipart_params), function(e, t) {
					v.append(t, e)
